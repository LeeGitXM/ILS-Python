...
'''
This is meant to be called from a Vision window for debugging and simulates the call from the Tolls menu and the designer hook
'''
...
def internalizeRecipeDataForChart(chartPath, chartXML, chartPaths, chartInfo, folderInfo, db):
    ...
    escape characters making it harder to read, which is the whole part of using XML.  So I am going to use text string
