...
def activate(scopeContext, stepProperties):
    import time
    from ils.sfc.gateway.util import getStepProperty, getDelaySeconds
    ...
    from ils.sfc.gateway.api import getDatabaseName, addControlPanelMessage, getCurrentMessageQueue
