...
def monitorDownload(scopeContext, stepProperties): 
    from system.ils.sfc.common.Constants import MONITOR_DOWNLOADS_CONFIG, DATA_ID, DOWNLOAD_STATUS, WRITE_CONFIRMED
    from ils.sfc.common.constants import PV_VALUE, PV_MONITOR_ACTIVE, PV_MONITOR_STATUS, STEP_PENDING, STEP_APPROACHING, \
    STEP_DOWNLOADING, STEP_SUCCESS, STEP_FAILURE, PV_NOT_MONITORED
