...
from ils.sfc.recipeData.api import s88GetStepInfoFromUUID, s88GetStepInfoFromId
...
def actionPerformed(event, response):
    ...
    print "From the root container properties, targetStepID: %d, responseKey: %s" % (targetStepID, responseKey)
